        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            ...
            <p className="mt-2 text-lg sm:text-xl text-white/90 font-semibold">
              Full Stack Developer / AI & Data Science learner
            </p>

            <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
              I build scalable, modern applications with a strong focus on clean architecture, delightful UX, and performance. React, Tailwind CSS, and FastAPI—bringing ideas to life from concept to production with robust APIs and smooth interfaces.
            </p>
        ...
        <div className="grid md:grid-cols-1">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
             I’m a Web Developer — passionate about building fast, resilient websites and sharing coding insights on Github.
            </p>
